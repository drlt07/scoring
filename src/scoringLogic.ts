...
function calculateSingleAlliance(
  ...
  // 1. Điểm sinh học
  const bioPoints = score.yellowBalls * 3 + score.whiteBalls * 1;
...
export function calculateAllianceScore(score: AllianceScore): AllianceScore {
  ...
  return calculateSingleAlliance(score, barrierPts, coeffDelta);
}
...
export function calculateMatchScores(redScore: AllianceScore, blueScore: AllianceScore) {
  ...
  return {
    red: calculateSingleAlliance(redScore, barrierOutcome.redBarrierPoints, barrierOutcome.redCoeffDelta),
    blue: calculateSingleAlliance(blueScore, barrierOutcome.blueBarrierPoints, barrierOutcome.blueCoeffDelta),
  };
}
